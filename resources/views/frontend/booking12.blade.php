...
<div class="col-xs-12 col-sm-12 col-md-3 col-md-push-9 col-lg-push-9 col-lg-3 side-bar">
                        ...
                        <div class="row" style="margin-top: 4px;">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding: 0px">
                                ...
                                <h3 style="padding:13px 20px 13px !important" class="btn btn-lg btn-yellow col-sm-12 col-xs-12 col-md-12"
                                    ...
                                    &pound; <span id="totalPrice">0</span>
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="col-lg-5">
                                                            ...
                                                            <input class="form-control bf-inptfld" required type="text" placeholder="First Name"
                                                        ...
                                                        <div class="col-lg-5">
                                                            ...
                                                            <input class="form-control bf-inptfld" type="text" placeholder="Last Name"

                                                                   name="lastname" required id="lastname" value="">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input email="true" class="form-control bf-inptfld" placeholder="Email"
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input class="form-control bf-inptfld" type="text" placeholder="Confirm Email"

                                                                   email="true"

                                                                   equalTo="#email"

                                                                   name="c_email" id="c_email" required value="">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input class="form-control bf-inptfld" type="text" placeholder="Mobile"
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="col-lg-12 margin15" id="vechile-detail">
                                                        ...
                                                        <div class="col-lg-3 ">
                                                            ...
                                                            <input class="form-control bf-inptfld" type="text" required
    ...
    margin: auto;"
                                                             ...
                                                             src="{{ asset("assets/payzone/images/payzone_cards_accepted.png") }}"></div>
...
<!-- placeholder for Elements -->
                                                        <div id="card-element"></div>
                                                               ...
                                                               <center>  <h4 style="margin-top:10px;"><span class="badge badge-warning" style="background-color:transparent;" >Your Card Will Be Charged</span> <span class="badge badge-danger" style="background-color:#090;" > <strong>£<span

                                                                                id="ccPrice">0</span></strong></span></h4> </center>
                                                            ...
                                                            <center> <button class="btn cnf_booking btn-lg btn-warning center-block"
...
//
    ...
    @if($settings["payment_type"]=='stripe')
        ...
        <script src="{{ asset('assets/stripe/index.js?123') }}"></script>
