...
.search1{
    ...
    background: 
        linear-gradient(rgba(31, 30, 30, 0.5), rgba(0, 0, 0, 0.705)),
        url('/public/theme/images/home_hero_bg.jpg');
...
.button{background-color: #C2185B !important;}
</style>
    ...
    <div class="search1">
        ...
        <div class="container fill_height" >
            <div class="row fill_height">
                <div class="col fill_height" style="    margin-bottom: 10px;">
                    <h1 class="main-heading"><b><span style="color:#C2185B">About</span>  Us </b></h1>
                    <div id="home_search_form" class="search_panel1">
                        <!--<h2 class="main-heading-h2"><b><span style="color:#C2185B">BOOK</span> NOW</b></h2>-->
