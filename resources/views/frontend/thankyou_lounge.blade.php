...
@php
    $loungeTitle = $lounge_name ?? 'Airport Lounge';
    $airportName = $airport_detail->name ?? optional($booking->airport)->name ?? '';
                                ...
                                <div id="thankyou" class="main-area" style="float: left; width: 100%;">
                                    ...
                                    <div class="confirm col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <p class="first-p" style="text-align: center;">
                                            Thank you for completing booking. This is your lounge booking confirmation with all your booking details.
                                        ...
                                        <div class="detail col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="sub-detail" style="float: left; width: 100%;">
                                                ...
                                                <hr style="border:1px solid #C2185B; border-top: none !important;">
                                                <h2 class="first-h1" style="text-align: center;">
                                                    Lounge <span style="color:#C2185B">Detail</span>
                                                </h2>
                                                <hr style="border:1px solid #C2185B; border-top: none !important;">
                                                <div class="row row-m">
                                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                                        <ul>
                                                            <li class="li-h">Lounge Name:</li>
                                                            <li class="li-p">{{ $loungeTitle }}</li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                                        <ul>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                                        <ul>
                                                            <li class="li-h">Terminal:</li>
                                                            <li class="li-p">T-{{ $booking->terminal }}</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row row-m">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                                        <ul>
                                                            <li class="li-h">Lounge entry</li>
                                                            <li class="li-p">
                                                                {{ date('l, d M Y', strtotime($booking->check_in)) }}
                                                                at {{ date('H:i', strtotime($booking->check_in_time ?: $booking->check_in)) }}
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                                        <ul>
                                                            <li class="li-h">Passengers</li>
                                                            <li class="li-p">
