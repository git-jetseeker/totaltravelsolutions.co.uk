            ...
            <div class="col fill_height">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <i class="nav-icon fa fa-car"></i><img src="{{ asset('theme/images/suitcase.png') }}"
                                alt=""><span>Parking</span>
                        </div>
                        <div
                            class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start">
                            <img src="{{ asset('theme/images/bus.png') }}" alt="">Lounges
                        </div>
                        <div
                            class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start">
                            <img src="{{ asset('theme/images/departure.png') }}" alt="">Transfer
                        </div>
                ...
                <div class="search_panel">
                    <form action="#" id="search_form_2"
                        ...
                        <center> <button type="button" class="button search_button">Comming
