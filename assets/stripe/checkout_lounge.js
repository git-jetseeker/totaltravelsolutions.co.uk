...
hideSpinner();
                ...
                if ($("#personal_details_form").valid()) {
                    ...
                    if (valid_address()) {
                        ...
                        if (validate_vechiledetail()) {
                            ...
                            data['token'] ="test";
                            data['bookfhrSearchId'] = $('#bookingDetails input[name="bookfhrSearchId"]').val();
                            data['bookfhrOptionId'] = $('#bookingDetails input[name="bookfhrOptionId"]').val();
                            data['product_code'] = $('#bookingDetails input[name="product_code"]').val();
                            data['park_api'] = $('#bookingDetails input[name="park_api"]').val();
                            ...
                            console.log(clientSecret);
                              stripe.handleCardPayment(
                                ...
                                if (result.error) {
                                    ...
                                    // $.post('booking/payout_failed_lounge', data, function (resp) {
        ...
        //
                                    ...
                                    $.post('booking/payout_lounge', data, function (data) {
