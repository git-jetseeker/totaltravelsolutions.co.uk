                ...
                if ($("#personal_details_form").valid()) {
                    ...
                    if (valid_address()) {
                        ...
                        if (validate_vechiledetail()) {
                            ...
                            var data = {};
                            if ($("#smsfee").is(":checked")) {
                                data['smsfee'] = $("#smsfee").val();
                            } else { 
                                data['smsfee'] = 0;
                            }
                            
                            if ($("#cancelfee").is(":checked")) {
...
//
                            ...
                            data['g_quote'] = $('#bookingDetails input[name="g_quote"]').val();
                            data['g_token'] = $('#bookingDetails input[name="g_token"]').val();
                            data['token'] ="test";
                                ...
                                console.log(clientSecret);
                                  stripe.handleCardPayment(
                                    ...
                                    if (result.error) {
                                        ...
                                        // $.post('booking/payout_failed', data, function (resp) {
            ...
            //
                                ...
                                hideSpinner();
                                $("#error_personal_detail").html('<label class="error error-vech" >Something went wrong. Please try again later.</label>');
                            }
