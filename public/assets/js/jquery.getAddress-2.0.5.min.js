(function(n) {
    ...
    var i = [],
        r, u = "https://api.getAddress.io/v2/uk",
        f = {
            api_key: "",
            output_fields: {
                line_1: "#line1",
    ...
    t.prototype.lookupPostcode = function(t) {
        ...
        n.getAddress.lookupPostcode(t, i.api_key, function(n) {
            if (i.enableLookup(), i.sort_numerically && (n.Addresses = e(n.Addresses)), i.setDropDown(n.Addresses, t), i.onLookupSuccess) i.onLookupSuccess(n)
        }, function(n) {
