...
*/
namespace App\library\payzone\includes;

if (count(get_included_files()) ==1) {
    exit("Direct access not permitted.");
}

require_once('gateway/constants.php');
require_once('helpers/db_example.php');#DBExample
require_once('helpers/payzone_helper.php');

use Payzone\Helpers\DBControl as DB;#DBExasss
...
class PayzoneGateway
{
  ...
  public function __construct()
  {
    ...
    self::setMerchantId('PARKIN-7352837');// Enter the merchant ID from the MMS
    self::setMerchantPassword('H2138HZZ81');// Enter the merchant Password from the MMS
    self::setPreSharedKey('OCzJ5tueacOwL8adEGdLMrfhVbxbfHqAMvKjzIGeAWZNyfm');// Enter the pre shared key from the MMS
    self::setSecretKey('test452369');// secret key used to protect and verify data
    ...
    public function setURL($act, $val = null)
{
    ...
    public function buildFormRequest()
    {
      ...
      $EchoThreeDSecureAuthenticationCheckResult=Helper\PayzoneHelper::boolToString(false);
    ...
    public function buildXHRequest($data)
    {
//      if (!isset($_POST["OrderID"])) {//Validate information that has been passed across (via $_POST or $_GET) and process the information ready for the next stage of the payment process, including setting all of the variables for the payment handling with the system
//      }
        $params = array();
        ...
        $CV2= (isset($data["CV2"])) ? $data["CV2"] : "";
        $IssueNumber= (isset($data["IssueNumber"])) ? $data["IssueNumber"] : "";
        $ExpiryDateMonth= (isset($data["ExpiryDateMonth"])) ? $data["ExpiryDateMonth"] : "";
        $ExpiryDateYear= (isset($data["ExpiryDateYear"])) ? $data["ExpiryDateYear"] : "";
        $StartDateMonth= (isset($data["StartDateMonth"])) ? $data["StartDateMonth"] : "";
        $StartDateYear= (isset($data["StartDateYear"])) ? $data["StartDateYear"] : "";
