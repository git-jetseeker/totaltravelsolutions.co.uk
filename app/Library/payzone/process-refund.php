...
<body onload="payzonePaymentPageLoad();">
  <form class='payzone-form' id='payzone-payment-form' name='payzone-refund-form' target="_self" method="POST" style='display:none' action="<?php echo $PayzoneGateway->getURL('form-action-payment'); ?>" >
    <?php
