...
class DPayPal {
    //API Credentials
    //protected $username = "imran-facilitator_api1.flyparkplus.co.uk"; //PayPal API username
    protected $username = "imran_api1.flyparkplus.co.uk"; //PayPal API username
    //protected $password = "9ML29YLPEYPG9897"; //PayPal API password
    protected $password = "9EQR56ZCC8QP43NH"; //PayPal API password
    //protected $apiSignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31ASk-rv0WOrgN1NJ.Y7ybvu2ay8EO"; //PayPal API signature
    protected $apiSignature = "AiPC9BjkCyDFQXbSkoZcgqH3hpacAanFbLXoXghLDIEedXUWQRu-e5ma"; //PayPal API signature
